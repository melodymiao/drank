    ...
    >
      <svg viewBox="0 0 220 220" className="h-auto w-full max-w-[150px]" xmlns="http://www.w3.org/2000/svg">
        ...
        <text fontFamily="var(--font-ibm-plex-mono), monospace" fontWeight={500} fontSize="15" fill="#481D0F">
          <textPath href="#avg-score-top" startOffset="4%" textLength="238" lengthAdjust="spacing">avg score &#183; avg score &#183;</textPath>
        </text>
        <text fontFamily="var(--font-ibm-plex-mono), monospace" fontWeight={500} fontSize="15" fill="#481D0F">
          <textPath href="#avg-score-bottom" startOffset="4%" textLength="238" lengthAdjust="spacing">avg score &#183; avg score &#183;</textPath>
        </text>
