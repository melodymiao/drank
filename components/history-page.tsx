...
/* ─────────────────────────────────────────────────────────────
   Cup placeholder stickers (when no photo) — 3 variants, picked by index
─────────────────────────────────────────────────────────────── */
const CUP_STICKERS = [
  "/history-placeholder-pink.png",
  "/history-placeholder-green.png",
  "/history-placeholder-blue.png",
]
              ...
              <div className="flex flex-col items-center gap-3 py-16 text-center">
                {receipts.length === 0 ? (
                  <div className="size-12 flex items-center justify-center">
                    <Image src={CUP_STICKERS[0]} alt="" width={48} height={48} className="size-12 object-contain" />
                  </div>
                ) : null}
